...
})({"gCdfI":[function(require,module,exports) {
"use strict";
...
document.addEventListener("DOMContentLoaded", ()=>{
    const onScrollHeader = ()=>{
        ...
        window.addEventListener("scroll", ()=>{
            ...
            ;
            if (currentScroll > 100 && currentScroll > prevScroll && !headerHidden()) header.classList.add("header__nav-fixed") // то скрываем header
            ;
...
},{}]},["gCdfI","68XbT"], "68XbT", "parcelRequirec448")
