...
triggersForModal_4.forEach((e)=>{
    e.addEventListener("click", (event)=>{
        ...
        document.body.style.overflow = "hidden";
        modals[3].querySelector(".iframe").insertAdjacentHTML("beforeend", `<iframe height="560" src="https://www.youtube.com/embed/Xj6pj12ywN8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`);
    });
});
...
const byebye = (event)=>{
    if (!event.toElement && !event.relatedTarget && event.offsetY < 1) setTimeout(()=>{
        openModal(1);
...
},{}]},["1gjnD","aHHgN"], "aHHgN", "parcelRequirec448")
